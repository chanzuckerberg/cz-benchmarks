...
if __name__ == "__main__":
    ...
    config_dict = OmegaConf.to_container(
        config.model_config[uce_variant], resolve=True
    )
    config_dict["adata_path"] = "s3://generate-cross-species/datasets/tsv2/homo_sapiens_10df7690-6d10-4029-a47e-0f071bb2df83_Lymph_Node_v2_curated.h5ad"
