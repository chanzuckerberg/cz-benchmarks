...
- [`KkTestTask`](../autoapi/czbenchmarks/tasks/single_cell/kk_test/index): Evaluates rare cell type detection performance by training classifiers on embeddings to distinguish rare cell types from common ones. Uses metrics including F1 score, precision, recall, balanced accuracy, and Matthews correlation coefficient.
