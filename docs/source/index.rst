...
- ✅ Modular: Add models, tasks, and metrics easily
- 🤜 Extensible: Build custom benchmarks
- 📊 Metrics-rich: Evaluate models across clustering, integration, perturbation, and prediction
- 🧬 Single-cell native: Works seamlessly with AnnData and biological datasets
- 🚀 Scalable: Use container-based execution with GPU support
