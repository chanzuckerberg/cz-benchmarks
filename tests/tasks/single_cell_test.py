...
def sample_single_cell_dataset():
    """Load a real SingleCellDataset from the given h5ad file."""
    file_path = "./app/raw/example-small.h5ad"
...
def test_clustering_task(sample_single_cell_dataset):
    """Test the ClusteringTask execution and metric computation."""
...
def test_embedding_task(sample_single_cell_dataset):
    """Test the EmbeddingTask execution and metric computation."""
