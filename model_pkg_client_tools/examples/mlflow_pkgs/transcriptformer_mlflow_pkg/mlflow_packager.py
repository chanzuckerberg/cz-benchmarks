...
inference. The package artifact will be written to `mlflow_model_artifact`.
...
ARTIFACT_DIR_NAME = "mlflow_model_artifact"
...
def _parse_cli(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        "Artifact will be written to a directory called `mlflow_model_artifact`.",
    )
...
def main(argv: list[str] | None = None) -> None:
    ...
    LOGGER.info(
        ...
        os.path.abspath(ARTIFACT_DIR_NAME),
    )
