...
if __name__ == "__main__":
    ...
    filtered_data_path = f"{os.environ['HOME']}/.cz-benchmarks/datasets/replogle_k562_essential_perturbpredict_de_results_control_cells_v2.h5ad"
    ...
    # Uncomment this for a de reference table. NB values will be different, but there should be similarities.
    de_reference = pd.DataFrame(adata_filtered.uns["de_results_wilcoxon"]) 
    ...
    for deg_test_name in [deg_name]:
        ...
        results = scp.run_multicondition_dge_analysis(
            ...
            filter_min_cells=0, #0,
            filter_min_genes=0, #0,
            min_pert_cells=1, #1,
